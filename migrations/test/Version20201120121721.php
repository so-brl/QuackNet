 ...
 */
final class Version20201120121721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_83D44F6FC6E59929 ON quack (autheur_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_83D44F6FC6E59929 ON quack');
        $this->addSql('DROP INDEX IDX_83D44F6F60BB6FE6 ON quack');
        $this->addSql('ALTER TABLE quack ADD autheur VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP autheur_id');
    }
}
